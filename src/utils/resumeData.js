...
export default {
    ...
    about: 
    "I am a dedicated Computer Science student at the University of Minnesota, where I am also pursuing minors in Management Information Systems and Statistics. My academic achievements include a strong GPA of 3.4 and recognition through awards such as the Dean’s List and Page Scholar. \n\nMy coursework has equipped me with a solid foundation in programming languages like Java, Python, JavaScript, C, HTML/CSS, and R. I have applied these skills in various projects, including developing a queue system website to improve classroom TA hour management and creating interactive games like Minesweeper and Starship. These experiences have honed my abilities in object-oriented programming, advanced algorithms, and responsive design. \n\nOutside the classroom, I enjoy mentoring students as a Coding Tutor at Code Ninjas, where I've helped over 50 students bring their coding ideas to life. My board positions with the National Society of Black Engineers and the Ethiopian Student Association have strengthened my leadership skills, allowing me to organize events, foster community engagement, and collaborate with diverse teams. \n\nBeyond my academic and technical pursuits, I'm deeply committed to giving back to my communities. Through my leadership roles, I strive to create opportunities for underrepresented students in STEM, provide mentorship, and support initiatives that promote diversity and inclusion in technology. I believe in using my skills to drive meaningful change and help others gain access to the resources and opportunities they need to succeed. \n\nI'm always eager to connect with fellow tech enthusiasts and professionals. I’m excited about the future and look forward to contributing to innovative solutions that make a difference. Let’s connect!",
    projects: [
        {
            title: 'Queue Website',
            description: `
